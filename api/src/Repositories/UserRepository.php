...
class UserRepository extends BaseRepository {
    ...
    public function createAdmin(string $username, string $email, string $password, string $profile_picture = null, string $bio): ?User{
        ...
        try{
            ...
            if ($e->getCode() =='23000') {
                throw new \Exception("email et/ou pseudo  admin déjà utilisé");
            }
            throw $e;
        }
    ...
    public function deleteUser(int $id): ?User {
        ...
        $this
            ->query("UPDATE users SET is_deleted = 1 WHERE id = :id AND role = 0")
            ->fetch(['id' => $id])
        ;
