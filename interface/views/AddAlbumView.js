export class AddAlbumView {
    ...
    render() {
        this.root.innerHTML = `
             <div class="max-w-xl mx-auto p-6 bg-base-100 rounded-xl shadow-xl text-base-content mt-10">
  <h1 class="text-3xl font-bold text-center red-color mb-6">Créer un Album</h1>

  <form id="createAlbumForm" class="space-y-6">
    ...
    <div class="form-control mt-6">
      <button type="submit" class="btn btn-primary w-full">Créer l'album</button>
    </div>
  </form>
</div>
